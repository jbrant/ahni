 ...
 * 
 * Created on Mar 9, 2004 by Philip Tucker Edited by Oliver Coleman
 */
...
/**
 * Although any object taking and returning double arrays can implement this,
 * it is meant to be a simple neural net interface where the arrays are input
 * and output activation patterns.
 * 
...
public interface Activator extends XmlPersistable
{
   ...
   *         <code>nextSequence(double[])</code> or
   *         <code>nextSequence(double[][])</code>.
  ...
  /**
   * @param stimuli
   * @return double[][] sequence of output arrays given input sequence
   *         <code>stimult</code>.
   */
  ...
  /**
   * @return dimension(s) of input array. If the input array is a single
   *         dimension vector then the returned array will have length 1; in
   *         general the returned array will have as many elements as there are
   *         dimensions in the input vector.
   */
  public int[] getInputDimension();

  /**
   * @return dimension(s) of output array. If the output array is a single
   *         dimension vector then the returned array will have length 1; in
   *         general the returned array will have as many elements as there are
   *         dimensions in the output vector.
   */
   ...
   * 
   * @param g
   *        the graphics object to render the network to.
   * @param width
   *        The desired width in pixels of the rendering.
   * @param height
   *        The desired height in pixels of the rendering.
   * @param neuronSize
   *        The desired size in pixels of the neurons.
